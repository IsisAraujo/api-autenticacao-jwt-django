...
class PerfilSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'email', 'username', 'telefone', 'nome', 'avatar', 'data_cadastro', 'email_confirmado')
        ...
        if email and password:
            ...
            if usuario:
                if not usuario.email_confirmado:
                    raise serializers.ValidationError(_('Email não confirmado. Por favor, ative sua conta.'))
