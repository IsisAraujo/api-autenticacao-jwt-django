...
class ContaTests(TestCase):
    def setUp(self):
        ...
        self.dados_usuario = {"email": "teste@exemplo.com", "password": "senhateste"}
...
class CadastroTests(TestCase):
    ...
    def test_cadastro_duplicado(self):
        ...
        get_user_model().objects.create_user(
            email="teste@exemplo.com", password="senhaexistente"
        )
...
class AtivacaoContaTests(TestCase):
    def setUp(self):
        ...
        self.ativacao_conta = AtivacaoConta.objects.create(
            usuario=self.usuario, codigo_ativacao=self.codigo_ativacao
        )
    ...
    def test_ativacao_conta(self):
        ...
        self.assertFalse(
            AtivacaoConta.objects.filter(pk=self.ativacao_conta.pk).exists()
        )
