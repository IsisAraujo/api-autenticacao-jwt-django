...
urlpatterns = [
    path(
        "usuario/cadastrar/", CadastrarUsuarioView.as_view(), name="cadastrar_usuario"
    ),
    ...
    path(
        "usuario/verificar-alteracao-email/",
    ...
    path(
        "solicitar-novo-codigo-ativacao/",
