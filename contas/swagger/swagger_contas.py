...
from contas.serializers import CadastroSerializer, PerfilSerializer, LoginSerializer, AlterarPerfilSerializer
...
cadastrar_usuario_schema = swagger_auto_schema(
    request_body=openapi.Schema(
        ...
        properties={
            ...
            'telefone': openapi.Schema(type=openapi.TYPE_STRING, description='Número de telefone do usuário com DDD'),
...
login_schema = swagger_auto_schema(
    ...
    responses={
        200: openapi.Response('Login bem-sucedido', schema=openapi.Schema(
            type=openapi.TYPE_OBJECT,
            properties={
...
ativacao_conta_schema = swagger_auto_schema(
    ...
    request_body=openapi.Schema(
        ...
        required=['codigo'],
        properties={
            'codigo': openapi.Schema(type=openapi.TYPE_STRING, description='Código de ativação'),
        },
    ),
    responses={
        200: 'Conta ativada com sucesso',
        400: 'Código de ativação inválido'
    }
)
...
verificar_reset_senha_schema = swagger_auto_schema(
    ...
    request_body=openapi.Schema(
        ...
        properties={
            'code': openapi.Schema(type=openapi.TYPE_STRING, description='Código de verificação'),
...
alterar_email_schema = swagger_auto_schema(
    ...
    request_body=openapi.Schema(
        ...
        required=['email'],
        properties={
            'email': openapi.Schema(type=openapi.TYPE_STRING, description='Email atual do usuário'),
        },
    ),
    responses={
...
verificar_alteracao_email_schema = swagger_auto_schema(
    ...
    request_body=openapi.Schema(
        ...
        properties={
            'code': openapi.Schema(type=openapi.TYPE_STRING, description='Código de verificação'),
            'new_email': openapi.Schema(type=openapi.TYPE_STRING, description='Novo email'),
        },
    ),
    responses={
