...
CORS_ALLOWED_ORIGINS = [os.getenv("CORS_ALLOWED_ORIGINS", "https://seu-dominio-de-producao.com")]
...
CSRF_TRUSTED_ORIGINS = [os.getenv("CSRF_TRUSTED_ORIGINS", "https://seu-dominio-de-producao.com")]